...
})({"40rQl":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = 'pk.eyJ1IjoiamFtZXNjb29sMTIzIiwiYSI6ImNsMjgxZnBoczA1MDQzanIxaTBvZXZheXcifQ.v_cz3tbsyrZbnKwRq34TRQ';
...
const updateSettings = async (data, type)=>{
    try {
        const url = type === 'password' ? 'http://127.0.0.1:3001/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3001/api/v1/users/updateMe';
        const res = await _axiosDefault.default({
            method: 'PATCH',
            url,
            data
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
/* eslint-disable */ const stripe = Stripe('pk_test_51Kse9YBryKZWmj4BekuQeTMu3iEZYr8azCkljWjRRz7MrrMFsKBpF4dDMc6QdBtYVHl82Zz927CebajK07xqfueW00Aw9nWfMI');
const bookTour = async (tourId)=>{
    try {
        // 1) Get checkout session from API
        const session = await _axiosDefault.default(`http://127.0.0.1:3001/api/v1/booking/checkout-session/${tourId}`);
        console.log(session);
...
},{"./alerts":"6Mcnf","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["40rQl","f2QDv"], "f2QDv", "parcelRequire11c7")
